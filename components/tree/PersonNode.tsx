...
const PersonNode = ({ data }: PersonNodeProps) => {
  ...
  return (
    <div className="relative group">
       {/* Leaf Decorations */}
       <div className="absolute -top-3 -left-3 text-green-600/80 transform -rotate-45 z-0">
          <Leaf size={24} fill="currentColor" />
       </div>
       <div className="absolute -bottom-2 -right-2 text-green-700/60 transform rotate-12 z-0">
